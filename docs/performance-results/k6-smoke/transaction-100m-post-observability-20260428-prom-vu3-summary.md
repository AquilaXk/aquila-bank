# transaction-100m-post-observability-20260428-prom-vu3-summary

## Archive Metadata

- archivedAt: 2026-04-28T01:33:27Z
- resultPurpose: smoke
- reportClass: transaction-100m-smoke
- sourceMarkdown: build/reports/k6/transaction-100m-post-observability-20260428-prom-vu3-summary.md
- sourceJson: build/reports/k6/transaction-100m-post-observability-20260428-prom-vu3-summary.json
...
- run id: transaction-100m-post-observability-20260428-prom-vu3
- vus: 3
- duration: 15s
- warmup duration: 10s
...
- hot first p95 ms: 2.0037125
- hot first p99 ms: 6.306141999999999
- hot first p99.9 ms: 18.133765806000092
- hot first max ms: 44.224084
- hot cursor p95 ms: 2.113559749999997
- hot cursor p99 ms: 7.1984578799999985
- hot cursor p99.9 ms: 18.285301625000105
- hot cursor max ms: 43.006458
- cold first p95 ms: 2.0241061999999994
- cold first p99 ms: 9.272831749999996
- cold first p99.9 ms: 17.085614819002426
- cold first max ms: 43.29925
- cold cursor p95 ms: 2.086739349999999
- cold cursor p99 ms: 6.139247129999999
- cold cursor p99.9 ms: 16.71038187500031
- cold cursor max ms: 43.227
