...
기본값은 `STAGING_RDS_ARCHIVE_RESULTS=true`입니다. k6 summary는 `build/reports/k6`에 생성되고 Markdown 사본은 `docs/performance-results`에 보관됩니다. 결과 문서에는 `optional staging RDS comparison` 성격을 명시합니다.
