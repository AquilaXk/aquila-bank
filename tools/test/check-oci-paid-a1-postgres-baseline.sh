...
require_pattern 'default     = 300' "${module_dir}/variables.tf"
require_pattern 'default     = 10' "${module_dir}/variables.tf"
require_pattern 'oci_core_volume' "${module_dir}/storage.tf"
require_pattern 'size_in_gbs  = var.postgres_data_volume_size_in_gbs' "${module_dir}/storage.tf"
require_pattern 'vpus_per_gb  = var.postgres_data_volume_vpus_per_gb' "${module_dir}/storage.tf"
...
require_pattern 'instance_ocpus = 4' "${module_dir}/terraform.tfvars.example"
require_pattern 'instance_memory_in_gbs = 24' "${module_dir}/terraform.tfvars.example"
require_pattern 'boot_volume_size_in_gbs = 50' "${module_dir}/terraform.tfvars.example"
require_pattern 'postgres_data_volume_size_in_gbs = 300' "${module_dir}/terraform.tfvars.example"
