...
awk -F '\t' '$1 == "hikari-lifetime" && $4 == 30 && $39 == "oci://run-hikari/hikari-config.tsv" && $40 == 240000 && $41 == 60000 && $42 == 300000 && $43 == 350000 && $44 == "oci://run-hikari/hikari-zero-warning.md" { found = 1 } END { exit !found }' "${execution_tsv}"
