...
print_dry_run() {
  ...
  echo "OUTBOX_OPS_ENABLED=true NOTIFICATION_CHANNEL_PROVIDER_OPS_ENABLED=true docker compose ${compose_files[*]} --profile loadtest up -d postgres aquila-bank-backend"
