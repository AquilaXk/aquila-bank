...
awk -F '\t' '$1 == "hikari-lifetime" && $5 == 30 && $30 ~ /hikari-config[.]tsv$/ && $31 == 120000 && $32 == 30000 && $33 == 300000 && $34 == 350000 && $35 ~ /hikari-zero-warning[.]md$/ { found = 1 } END { exit !found }' "${summary_tsv}"
