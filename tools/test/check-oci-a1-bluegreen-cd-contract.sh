...
script_patterns=(
  ...
  'OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_MAX=${OCI_A1_TRANSACTION_READ_ADMISSION_MAX:-6}'
  'OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ADAPTIVE_MIN=${OCI_A1_TRANSACTION_READ_ADMISSION_MIN:-5}'
  'OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ADAPTIVE_MAX=${OCI_A1_TRANSACTION_READ_ADMISSION_ADAPTIVE_MAX:-8}'
