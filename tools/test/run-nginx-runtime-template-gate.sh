...
if ! contains_pattern "limit_req zone=aquila_bank_transaction_hot_per_ip burst=16 nodelay;" ||
  ! contains_pattern "limit_req zone=aquila_bank_transaction_archive_per_ip burst=16 nodelay;"; then
