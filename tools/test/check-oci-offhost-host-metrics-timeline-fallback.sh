...
grep -F $'offhost-fallback-run\tarrival16\tgenerator\tk6-generator-a\tocid1.instance.oc1..generatora\tvm-k6-a\tsubnet-generator-a\toci-k6-generator-a\t2026-05-04T04:00:00Z\t2026-05-04T04:01:00Z\t60\tfallback-snapshot\t0\t31.2\t44.1\t10.5\t18.2\t12.1\t19.7\tartifact://offhost/generator.tsv#arrival16\tartifact://offhost-capacity-prerequisite/offhost-fallback-check/arrival16/summary\tartifact://offhost-capacity-prerequisite/offhost-fallback-check' "${timeline_tsv}" >/dev/null
grep -F $'offhost-fallback-run\tburst-matrix\ttarget\toci-a1-staging\tocid1.instance.oc1..target\tvm-target\tsubnet-target\ttarget\t2026-05-04T04:00:00Z\t2026-05-04T04:01:00Z\t60\tfallback-snapshot\t0\t52.4\t66.8\t21.1\t30.4\t25.6\t34.2\tartifact://offhost/target.tsv#burst-matrix\tartifact://offhost-capacity-prerequisite/offhost-fallback-check/burst-matrix/summary\tartifact://offhost-capacity-prerequisite/offhost-fallback-check' "${timeline_tsv}" >/dev/null
