...
grep -F "max_backend_429_rate=0.02" <<<"${plan}" >/dev/null
...
jq '.metrics.aquila_transaction_edge_429_rate.values.rate = 0.31 | .metrics.aquila_transaction_502_count.values.count = 1' \
