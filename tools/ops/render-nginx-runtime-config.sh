...
NGINX_TRANSACTION_READ_HOT_RATE_RPS="${NGINX_TRANSACTION_READ_HOT_RATE_RPS:-96}"
NGINX_TRANSACTION_READ_ARCHIVE_RATE_RPS="${NGINX_TRANSACTION_READ_ARCHIVE_RATE_RPS:-96}"
NGINX_TRANSACTION_READ_HOT_BURST="${NGINX_TRANSACTION_READ_HOT_BURST:-12}"
NGINX_TRANSACTION_READ_ARCHIVE_BURST="${NGINX_TRANSACTION_READ_ARCHIVE_BURST:-12}"
NGINX_TRANSACTION_READ_HOT_DELAY="${NGINX_TRANSACTION_READ_HOT_DELAY:-1}"
NGINX_TRANSACTION_READ_ARCHIVE_DELAY="${NGINX_TRANSACTION_READ_ARCHIVE_DELAY:-1}"
