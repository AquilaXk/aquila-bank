...
require_non_negative_integer "NGINX_HSTS_MAX_AGE_SECONDS" "${NGINX_HSTS_MAX_AGE_SECONDS}"
...
rendered="${rendered//'${NGINX_HSTS_MAX_AGE_SECONDS}'/${NGINX_HSTS_MAX_AGE_SECONDS}}"
