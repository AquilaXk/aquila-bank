...
const required = [
  ...
  ["page application result binding", files.page, "customerApplicationResult"],
  ["page submit handler binding", files.page, "handleSubmitCustomerApplication"],
  ["application request type", files.apiTypes, "CustomerApplicationRequest"],
  ["application response type", files.apiTypes, "CustomerApplicationResponse"],
  ["application type enum mirror", files.apiTypes, "CustomerApplicationType"],
  ["application API method", files.apiClient, "submitCustomerApplication"],
  ["application API path", files.apiClient, "/api/v1/customer-service/applications"],
  ["application idempotency header", files.apiClient, "Idempotency-Key"],
  ["application hook state", files.hook, "customerApplicationResult"],
  ["application hook handler", files.hook, "handleSubmitCustomerApplication"],
  ["application submit handler type", files.types, "CustomerApplicationSubmitHandler"],
  ...
  ["enterprise bill payment write type", files.enterprise, "BILL_PAYMENT"],
  ["enterprise open banking write type", files.enterprise, "OPEN_BANKING_CONNECTION"],
  ["enterprise deposit write type", files.enterprise, "DEPOSIT_PRODUCT_APPLICATION"],
  ["enterprise loan write type", files.enterprise, "LOAN_APPLICATION"],
  ["enterprise fx write type", files.enterprise, "FOREIGN_EXCHANGE_APPLICATION"],
  ["enterprise submit binding", files.enterprise, "onSubmitCustomerApplication"],
  ...
  ["support incident write type", files.support, "INCIDENT_REPORT"],
  ["support certificate issuance write type", files.support, "CERTIFICATE_ISSUANCE"],
  ["support submit binding", files.support, "onSubmitCustomerApplication"],
  ...
  ["security certificate registration write type", files.securityHub, "CERTIFICATE_REGISTRATION"],
  ["security media write type", files.securityHub, "SECURITY_MEDIA_APPLICATION"],
  ["security submit binding", files.securityHub, "onSubmitCustomerApplication"],
...
const forbidden = [
  ...
  ["security write fetch", files.securityHub, "fetch("],
