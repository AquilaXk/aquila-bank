...
const checks = [
  ...
  ["login required notice", files.page, "로그인 필요"],
  ["unauth work gate heading", files.page, "로그인이 필요한 업무"],
  ["unauth security center login", files.page, "인증센터 로그인"],
  ...
  ["auth public heading", files.security, "로그인 및 인증"],
  ["auth member heading", files.security, "인증 후 보안관리"],
