...
const checks = [
  ...
  ["spacing safe service map breathing", files.styles, "padding: 6px 14px"],
  ["spacing safe utility search hook", files.page, "spacing-safe-search"],
  ["spacing safe utility search block padding", files.styles, "padding-block: 4px"],
  ["spacing safe side menu hook", files.page, "spacing-safe-side-menu"],
  ["spacing safe side item gap", files.styles, "gap: 5px"],
  ["spacing safe compact side item height", files.styles, "min-height: 56px"],
  ["spacing safe active side selector", files.styles, ".spacing-safe-side-menu .side-item.active"],
  ["spacing safe active side padding", files.styles, "padding-left: 16px"],
  ["spacing safe mobile side item padding", files.styles, "padding: 10px 14px"],
  ["spacing safe mobile side title padding", files.styles, "padding: 8px 14px"],
  ["spacing safe work tabs to title selector", files.styles, ".work-tabs + .section-title"],
  ["spacing safe work tabs title breathing", files.styles, "margin-top: 16px"],
  ["top channel nav hook", files.page, "top-channel-nav"],
  ["top channel nav active state", files.page, "activeTopNavId"],
  ["top channel business route", files.page, "enterpriseServices"],
  ...
  ["spacing safe brand row wrap gap", files.styles, "gap: 12px 20px"],
