...
const required = [
  ...
  ["ops route metadata title", files.page, "Aquila Bank Ops Console"],
  ["feature flag", files.component, "NEXT_PUBLIC_OPS_CONSOLE_ENABLED"],
  ["ops visible h1", files.component, "className=\"ops-title\""],
  ["ops section navigation", files.component, "ops-section-nav"],
  ["ops outbox anchor", files.component, 'href: "#ops-outbox-summary"'],
  ["ops application anchor", files.component, 'href: "#ops-application-actions"'],
  ["ops write zone class", files.component, "ops-write-zone"],
  ["ops write zone collapsed details", files.component, "<details"],
  ["ops write zone summary", files.component, "<summary className=\"ops-lookup-title\">"],
  ...
  ["ops title style", files.styles, ".ops-title"],
  ["ops sticky section nav style", files.styles, ".ops-section-nav"],
  ["ops sticky section nav position", files.styles, "position: sticky"],
  ["ops write zone style", files.styles, ".ops-write-zone"],
  ["ops write summary cursor", files.styles, ".ops-write-zone > summary"],
