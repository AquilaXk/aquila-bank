...
backend_capacity_profile_env_args() {
  ...
  printf '%s\n' \
    ...
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_MAX=${OCI_A1_TRANSACTION_READ_ADMISSION_MAX:-16}" \
    ...
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ADAPTIVE_MAX=${OCI_A1_TRANSACTION_READ_ADMISSION_ADAPTIVE_MAX:-16}" \
    ...
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_HOT_MAX=${OCI_A1_TRANSACTION_READ_HOT_ADMISSION_MAX:-${OCI_A1_TRANSACTION_READ_ADMISSION_MAX:-16}}" \
    ...
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_HOT_ADAPTIVE_MAX=${OCI_A1_TRANSACTION_READ_HOT_ADMISSION_ADAPTIVE_MAX:-${OCI_A1_TRANSACTION_READ_ADMISSION_ADAPTIVE_MAX:-16}}" \
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ARCHIVE_MAX=${OCI_A1_TRANSACTION_READ_ARCHIVE_ADMISSION_MAX:-${OCI_A1_TRANSACTION_READ_ADMISSION_MAX:-16}}" \
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ARCHIVE_ADAPTIVE_MIN=${OCI_A1_TRANSACTION_READ_ARCHIVE_ADMISSION_MIN:-${OCI_A1_TRANSACTION_READ_ADMISSION_MIN:-6}}" \
    "-e" "OPS_API_ADMISSION_CONTROL_TRANSACTION_READ_ARCHIVE_ADAPTIVE_MAX=${OCI_A1_TRANSACTION_READ_ARCHIVE_ADMISSION_ADAPTIVE_MAX:-${OCI_A1_TRANSACTION_READ_ADMISSION_ADAPTIVE_MAX:-16}}"
}
