...
public final class LoginService implements LoginUseCase {
  ...
  public LoginResult login(LoginCommand command) {
    ...
    LoginUser user =
        userCredentialLoadPort
            ...
            .orElseGet(() -> consumeMissingUserPath(command.password()));
  ...
  private LoginUser consumeMissingUserPath(String password) {
  ...
  private void recordLoginFailure(LoginUser user, Instant now) {
